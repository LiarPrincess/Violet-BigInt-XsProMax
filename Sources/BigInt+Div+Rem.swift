...
extension BigInt {
  ...
  public static func % (lhs: BigInt, rhs: BigInt) -> BigInt {
    var copy = lhs
    return copy.div(other: rhs)
  }

  public static func %= (lhs: inout BigInt, rhs: BigInt) {
    var copy = lhs
    lhs = copy.div(other: rhs)
  }

  public func quotientAndRemainder(
    dividingBy other: BigInt
  ...
  private static let zero = BigInt()

  /// Returns remainder.
  internal mutating func div(other: BigInt) -> BigInt {
    ...
    case .less: // 3 / 5 = 0 rem 3
      ...
      self.storage.isNegative = remainderIsNegative
      let remainder = self
  ...
  private static func divMagnitude(
    ...
    if rhs.count == 1 {
      ...
      return BigInt(remainder.magnitude)
    }
    ...
    return BigInt(storageWithValidInvariants: remainder)
  }
